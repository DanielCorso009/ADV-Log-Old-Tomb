...
public class SeleBeh : MonoBehaviour
{
public int speed;
    ...
    private void OnTriggerStay2D(Collider2D col){
        if(!invulnerability){
            switch(col.tag)
                {
                case "sword":health-=1;invulnerability = true;StartCoroutine("Invulnerable");break;
                case "arrow":health-=0;invulnerability = true;StartCoroutine("Invulnerable");break;
                case "Bomb":health-=1;invulnerability = true;StartCoroutine("Invulnerable");break;
                default:               break; 
                }        
            }
    }
